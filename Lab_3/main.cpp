...
void init_base_class(Computer *base,string *mother_plata, int *ozu_size, string *type_computer){ //Computer *base,
    std::cout << "Enter name of mother plate: ";
    std::cin >> *mother_plata;
    std::cout << *mother_plata << std::endl;
    ...
    for(int i = 0; i < num; ++i) {
        ...
        switch (choice){
            case 1:{
                ...
                std::cout << serv.mother_plate<< endl;
